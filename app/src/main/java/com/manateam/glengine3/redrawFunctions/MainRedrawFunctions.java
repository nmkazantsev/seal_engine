...
public class MainRedrawFunctions {
    public static PImage redrawBox(List<String> params) {
        PImage image;
        image = loadImage("box.jpg");
        return image;
    }
    public static PImage redrawPolig(List<String> params) {
        PImage image;
        image = loadImage("box.jpg");
    ...
    public static PImage redrawBox2(List<String> params) {
        PImage image;
        image = loadImage("box.jpg");
        image.fill(255);
    ...
    public static PImage redrawFps(List<String> param) {
        PImage image = new PImage(100, 100);
        image.background(150);
        image.textSize(20);
        image.fill(0);
        if (param.size() > 0) {
            image.text(param.get(0), 10, 10);
        }
        return image;
    }
}
