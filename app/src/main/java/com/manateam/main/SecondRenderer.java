...
import static com.seal.seal_engine.OpenGLRenderer.fps;
import static com.seal.seal_engine.OpenGLRenderer.mMatrix;
import static com.seal.seal_engine.OpenGLRenderer.pageMillis;
import static com.seal.seal_engine.engine.config.MainConfigurationFunctions.applyCameraSettings;
import static com.seal.seal_engine.engine.config.MainConfigurationFunctions.applyMatrix;
import static com.seal.seal_engine.engine.config.MainConfigurationFunctions.applyProjectionMatrix;
...
import static com.seal.seal_engine.utils.Utils.map;
...
import com.seal.seal_engine.OpenGLRenderer;
import com.seal.seal_engine.engine.main.camera.CameraSettings;
import com.seal.seal_engine.engine.main.camera.ProjectionMatrixSettings;
import com.seal.seal_engine.engine.main.shaders.Shader;
import com.seal.seal_engine.engine.main.verticles.Poligon;
import com.seal.seal_engine.engine.main.verticles.Shape;
import com.seal.seal_engine.engine.main.verticles.SkyBox;
import com.seal.seal_engine.maths.Point;
import com.seal.seal_engine.maths.Vec3;
import com.seal.seal_engine.utils.SkyBoxShaderAdaptor;
